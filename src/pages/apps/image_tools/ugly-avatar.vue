<template>
  <section class="ugly-avatar">
    <div class="container">
      ...
      <button @click="generateFace">再来一张</button>
  ...
  <script>
  import * as faceShape from "@/utils/ugly-avatar/face_shape.js";
  import * as eyeShape from "@/utils/ugly-avatar/eye_shape.js";
  import * as hairLines from "@/utils/ugly-avatar/hair_lines.js";
  import * as mouthShape from "@/utils/ugly-avatar/mouth_shape.js";
